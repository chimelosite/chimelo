  ...
  return <section className="py-12 md:py-16 bg-slate-200">
      <div className="chimelo-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
          {featuredAreas.map((area, index) => <AreaCard key={index} icon={area.icon} title={area.title} description={area.description} link={area.link} />)}
        </div>
        
        <div className="flex justify-center mt-8">
          <Button asChild variant="outline" className="border-chimelo-silver text-chimelo-black hover:bg-chimelo-lightgray/10 px-6">
