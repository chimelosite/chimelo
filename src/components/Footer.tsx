    ...
    <footer className="bg-chimelo-black text-white">
      <div className="chimelo-container py-6 md:py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex items-center space-x-4 mt-6">
              ...
              <a href="https://wa.me/555132761950" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-white hover:text-chimelo-silver">
              ...
              <div className="block md:hidden">
                <div className="flex items-start">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="mb-1 font-medium text-white">📍 Santiago:</p>
                    <p className="text-white">Rua Marechal Deodoro, 806 - Centro<br />Santiago/RS - 97700-0004</p>
        ...
        <div className="hidden md:flex items-center justify-center space-x-8 mt-6 mb-4 text-base">
          ...
          <div className="flex items-center text-white">
            <MapPin size={16} className="mr-2 text-chimelo-silver" />
            <span><strong>Santiago:</strong> Rua Marechal Deodoro, 806, Centro</span>
          </div>
        </div>
